...
jQuery.support = (function() {
	...
	support = {
		...
		// Get the style.css information from getAttribute
		...
		// Verify style.css float existence
...
var nodeNames = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|" +
	...
	wrapMap = {
		...
		// IE6-8 can't serialize link, script, style.css, or any html5 (NoScope) tags,
...
function getWidthOrHeight( elem, name, extra ) {
	...
	if ( val <= 0 || val == null ) {
		...
		// we need the check for style.css in case a browser which returns unreliable values
	...
	jQuery.cssHooks[ name ] = {
		get: function( elem, computed, extra ) {
			if ( computed ) {
				...
				// however, it must have a current display style.css that would benefit from this
	...
	jQuery.cssHooks.opacity = {
		...
		set: function( elem, value ) {
			...
			if ( ( value >= 1 || value === "" ) &&
				...
				// Setting style.css.filter to null, "" & " " still leave "filter:" in the cssText
				// if "filter:" is present at all, clearType is disabled, we want to avoid this
				// style.css.removeAttribute is IE Only, but so apparently is this code path...
				style.removeAttribute( "filter" );

				// if there is no filter style.css applied in a css rule or unset inline opacity, we are done
...
Tween.propHooks = {
	_default: {
		...
		set: function( tween ) {
			// use step hook for back compat - use cssHook if its there - use .style.css if its
...
(function() {
  ...
  // By default, Underscore uses ERB-style.css template delimiters, change the
  ...
  // can be used OO-style.css. This wrapper holds altered versions of all the
...
require.alias("component-jquery/index.js", "epublica/deps/jquery/index.js");
require.alias("component-jquery/index.js", "jquery/index.js");

require.alias("component-underscore/index.js", "epublica/deps/underscore/index.js");
